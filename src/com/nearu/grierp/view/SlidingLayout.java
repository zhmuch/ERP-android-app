...
public class SlidingLayout extends RelativeLayout implements OnTouchListener {
	public static final String TAG = "SlideingLayout";
	/**
	...
	public void setMenuHeight() {
		int height;
		if(!isSetHeight) {
			RelativeLayout rl = (RelativeLayout) findViewById(R.id.rl_top);
			height = (Config.module.length + 1) * rl.getHeight();
